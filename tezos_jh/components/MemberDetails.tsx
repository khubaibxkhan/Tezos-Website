...
export default function MemberDetails({ member }: { member: Member }) {
  return (
    <motion.div
      className="w-full max-w-3xl bg-black/70 rounded-3xl p-12 shadow-2xl border border-purple-700 flex flex-col items-center backdrop-blur-xl transition-all duration-300 hover:shadow-purple-800/60"
